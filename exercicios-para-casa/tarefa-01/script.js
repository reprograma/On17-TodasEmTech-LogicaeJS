 ...
 */
      let nomeUsuario = "Andressa"
      let nomeSenha = "123"

      let loginUsuario = String (prompt("Digite seu login"))
      let loginSenha = String (prompt("Digite sua senha"))

      if (nomeUsuario === loginUsuario && loginSenha === nomeSenha) {
        alert("Bom dia")
      } else {
