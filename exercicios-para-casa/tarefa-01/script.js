 ...
 */
 let nomeUsuário = "Gabriella"
 let nomeSenha = "1234"

 let usuarioSenha = String(prompt("coloque seu usuario"));
 let senhaUsuario = String(prompt("coloque sua senha"));

 if (nomeUsuário === usuarioSenha && senhaUsuario === nomeSenha) {
   alert("Bom Dia!") 
 } else {
